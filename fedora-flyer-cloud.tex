...
\def\filename{fedora-flyer-cloud.tex}
\documentclass[
notumble,
%%nofoldmark,
%%dvipdfm,
...
\title{\includegraphics[keepaspectratio,width=0.8\textwidth]{Logo_fedoralogo.png}\vspace{1cm}\\\includegraphics[keepaspectratio,scale=0.5]{logo-color-cloud.png}\\\vspace{0.5cm}\LARGE{\textcolor{ResolutionBlue}{CLOUD}}}
...
\begin{itemize}
  ...
  \item \textbf{Elasticsearch} is full-featured and very popular self-standing open source indexing cloud, and now it's available by with just a ``yum install elasticsearch'' -- no, wait, make that ``dnf install elasticsearch''! 
...
\begin{figure}[h]
  \centering
  \includegraphics[keepaspectratio]{Fedora-cloud-v5a-infinity.png}
\end{figure}
\newpage
